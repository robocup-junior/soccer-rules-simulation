...
NOTE: This is a draft version of the rules for the league RCJ Soccer Simulation 2021.
The final version of the rules may differ slightly from this draft, but only in minor aspects.
...
{++If the ball accidentally leaves the field of play, it will be returned into play immediately,
