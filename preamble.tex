...
\title{\Large RoboCupJunior Soccer Simulation Rules \vspace{2ex} \\
\large $\bigcdot$ Simulation Demo Competition in Jan 2021 $\bigcdot$ \vspace{-10ex}}
...
\begin{tabular}{lr}
    \multicolumn{2}{l}{\textbf{Soccer Technical Committee 2021:}}\\
    Georgia Gallant           & USA\\
...
\resizebox{0.50\textwidth}{!}{
\begin{tabular}{lr}
    \multicolumn{2}{l}{\textbf{Soccer Tournament OC Jan 2021:}}\\
    Adrian Matejov            & Slovakia \\
    Christian Rieseberg       & Germany\\
    David Schwarz             & Germany\\
    Felipe Nascimento Martins & Netherlands (CHAIR)\\
    Hikaru Sugiura            & Japan\\
    Javier Delgado            & Mexico\\
    Keitaro Masaoka           & Japan\\
    Marco Dankel              & Germany\\
    Marek Suppa               & Slovakia\\
\end{tabular}}
